        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title">Lentitud en la Red</h4>
              <p class="card-category">Cliente: Empresa 2</p>
              <p class="card-category">Creado por: Usuario 10</p>
              <p class="card-category">Agenda Creado el: 18-04-2021 23:52</p>
              <p class="card-category">Estado de Agenda: Abierto</p>
            </div>
            <div class="card-body">
              <div id="typography">
                ...
                <div class="row">
                  ...
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eum blanditiis dignissimos suscipit distinctio alias magni molestiae totam a ullam provident natus libero, dolorem repellendus, inventore aspernatur dolor? Quos, facere quasi! Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni ipsa quo vitae debitis molestias sed facere veritatis nisi? Esse, perferendis ut? Libero adipisci autem laudantium, quia minus nisi praesentium sunt. Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ratione, eligendi eveniet consequuntur tenetur aut soluta officiis deserunt id dolor facere? Perspiciatis inventore eius voluptatibus? Quod corporis incidunt error eos laudantium.
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-header card-header-success">
              <p class="card-category">Comentado por: Usuario 1</p>
              <p class="card-category">Fecha Comentario: 18-04-2021 23:52</p>
            </div>
            <div class="card-body">
              <div id="typography">
                <div class="card-title">
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-header card-header-danger">
              <p class="card-category">Comentado por: Usuario 10</p>
              <p class="card-category">Fecha Comentario: 18-04-2021 23:52</p>
            </div>
            <div class="card-body">
              <div id="typography">
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-header card-header-warning">
              <p class="card-category">Nuevo Comentario:</p>
            </div>
            <div class="card-body">
              <div id="typography">

                <form action="${Home.jsp>=0?'EditarPersona.do' : 'Login.do'}" method="POST" name="formulario" id="formularioID">

                  <input type="hidden" value="${Home.jsp}" name="index">
      
                  <div class="col-12 text-center col-centered border">
                      <label for="Comentario"></label>
                      <textarea rows="20" id="Comentario" name="Comentario" maxlength="15000000" class="form-control"></textarea>
                      <div class="col-md-12 text-right">
                      <a class="nav-link" href="Atencion.do">
                          <button type="button" class="btn btn-warning">Comentar</button></a>
                      </div>
                  </div>
